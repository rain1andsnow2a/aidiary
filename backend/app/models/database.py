...
from sqlalchemy import String, Boolean, DateTime, Date, Integer, Text, func, JSON, ForeignKey, Enum as SAEnum
...
class User(Base):
    ...
    class_name: Mapped[Optional[str]] = mapped_column(String(100))
...
class CounselorWeeklyDigestLog(Base):
    """辅导员/心理老师周报发送记录，避免重复发送"""
    __tablename__ = "counselor_weekly_digest_logs"
    ...
    def __repr__(self) -> str:
        return f"<CounselorWeeklyDigestLog(user_id={self.user_id}, week_start={self.week_start})>"
