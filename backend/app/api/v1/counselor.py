...
- GET    /counselor/dashboard           获取辅导员/心理老师工作台数据
"""
...
from app.core.deps import get_current_active_user, require_counselor
from app.services.counselor_dashboard_service import build_counselor_dashboard
...
@router.get(
    ...
    summary="获取辅导员/心理老师专用看板",
)
async def get_counselor_dashboard(
    window_days: int = Query(14, ge=7, le=30, description="统计窗口，默认 14 天"),
    ...
    不包含学生原始日记正文。
    """
    return await build_counselor_dashboard(
        db=db,
